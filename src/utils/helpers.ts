...
import { ChallengeSubmission, LeaderboardEntry, Trip, FoodItem, RecyclingItem, ShowerData, Challenge, Crew, UserProfile } from '../types';
...
export const calculateLeaderboard = (
  ...
  submissions.forEach(submission => {
    const current = userScores.get(submission.userId) || { score: 0, displayName: submission.displayName };
